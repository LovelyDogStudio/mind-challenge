...
export class LevelIcon extends Icon {
	...
	constructor({ game: game, group: group, position: position = 0, callback: callback = () => {}, cols: cols, levelNumber: levelNumber = 0 }) {
		// save properties
		this.game = game;
		...
		// paint level number and lock/unlock icon
		this.__paintLevelNumber();
		(position) ? this.__paintLocked() : this.__paintUnLocked();
	}
