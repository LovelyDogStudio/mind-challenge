export class Boot extends Phaser.State {
	...
	preload() {
		...
		this.game.load.image("lock", require("../../assets/img/lock.png"));
		this.game.load.image("unlock", require("../../assets/img/unlock.png"));
		this.game.load.image("star-empty", require("../../assets/img/star-empty.png"));
		this.game.load.image("star-full", require("../../assets/img/star-full.png"));
